...
int main() {
    ...
    TrajectoryParam init_param{6.0f, 0.0f, 0.0f}; // p = (path len, middle_steer, final_steer)
    float k0 = 0.0f; // initial steer
    Pose2DTrajectory traj = optim.optimizeTrajectory(target_pose, init_param, k0, gp);
